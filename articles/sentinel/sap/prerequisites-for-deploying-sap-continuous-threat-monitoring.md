...
[!NOTE]
>
> Note: for everything related to SAP’s licenses, terms and conditions please contact SAP. > 
...
| **Required software** | SAP NetWeaver RFC SDK 7.50 ([Download here](https://aka.ms/sentinel4sapsdk))<br>Make sure that you also have an SAP user account in order to access the SAP software download page. Also note that for everything related to SAP’s licenses, terms and conditions please contact SAP |
